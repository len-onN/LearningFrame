...
<template>
  <LibraryPage
    ...
    :loading-more-public="library.loadingMorePublicDecks.value"
    :loading-more-mine="library.loadingMoreMyDecks.value"
    ...
    :loading-more-cards="library.loadingMoreManagedCards.value"
