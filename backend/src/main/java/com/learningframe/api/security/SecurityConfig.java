...
public class SecurityConfig {
    ...
    SecurityFilterChain securityFilterChain(HttpSecurity http, JwtAuthenticationFilter jwtAuthenticationFilter) throws Exception {
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.POST, "/api/study/anonymous/review").permitAll()
    ...
    @Bean
    CorsConfigurationSource corsConfigurationSource(@Value("${learningframe.cors.allowed-origins}") String allowedOrigins) {
